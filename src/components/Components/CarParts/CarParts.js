                ...
                return(
                    <div className={carpartsEdit.container}>
                            ...
                            <img src='\img\Logo.png' alt='Makina' />
                                <ul class="list-group list-group-horizontal" className={carpartsEdit.list1}>
                                    <li>
                                        <Link to='/'>Home</Link>
                                    </li>
                                    <li>
                                    ...
                                    <ul class="list-group list-group-horizontal" className={carpartsEdit.list2}>
                                    <li>
                            ...
                            <input className={carpartsEdit.myInput} type='text' placeholder='Search ... ' />
                            ...
                            <a href="#" className={carpartsEdit.gotoTopLink}> <span>Go to Top </span>
                                <i class="fa-solid fa-circle-arrow-up" style={{
                                    'position':'absolute',
                                    'fontSize': '25px',
                                    'color':'blue',
                                    'cursor':'pointer',
